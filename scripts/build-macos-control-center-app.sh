...
CODEXBAR_MANIFEST="${ROOT}/macos/VibeTVControlCenter/CodexBar-v0.45.2.manifest.json"
CODEXBAR_LICENSE="${ROOT}/macos/VibeTVControlCenter/CodexBar-LICENSE.txt"
CODEXBAR_ARCHIVE_NAME="CodexBar-macos-universal-0.45.2.zip"
