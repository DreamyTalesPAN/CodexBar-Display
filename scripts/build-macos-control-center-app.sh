...
CODEXBAR_MANIFEST="${ROOT}/macos/VibeTVControlCenter/CodexBar-v0.56.8.manifest.json"
CODEXBAR_LICENSE="${ROOT}/macos/VibeTVControlCenter/CodexBar-LICENSE.txt"
CODEXBAR_ARCHIVE_NAME="CodexBar-macos-universal-0.56.8.zip"
