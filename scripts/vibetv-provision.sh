...
required_assets=("/themes/mini/mini.gif" "/themes/u/mini-cl-1-b3c3f7.json")
...
Flow toggles:
  ...
  --require-asset PATH  Require an asset path in /assets after flashing.
                        ...
                        /themes/u/mini-cl-1-b3c3f7.json.
...
check_post_smoke_gif_state() {
  ...
  for attempt in 1 2 3 4 5 6 7 8; do
    if curl_get "$health_url" >"$body_file"; then
      if jq -e '.display.activeTheme == "mini-classic" and .display.themeSpec.active == true and .display.themeSpec.path == "/themes/u/mini-cl-1-b3c3f7.json" and .display.themeSpec.renderOk == true and .display.gif.activePath == "/themes/mini/mini.gif" and .display.gif.filePresent == true and .display.gif.decoderOpen == true and .display.gif.lastError == null' "$body_file" >/dev/null 2>&1; then
