...
// VibeTV uses only file callbacks, RGB565 big-endian palettes, RAW scanline
// callbacks and the regular LZW decoder. The profile removes runtime branches
// for Turbo, COOKED and framebuffer modes while preserving the upstream types.
#define ANIMATEDGIF_VIBETV_PROFILE 1
...
// VibeTV ESP8266 profile. All GIF entry points validate that the stream never
// requires a wider LZW code before this decoder is allocated.
#define MAX_CODE_SIZE 11
